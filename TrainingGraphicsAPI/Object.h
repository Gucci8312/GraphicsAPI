...
public:
	...
	bool ObjectCreate(ID3D11Device* Device, Vertex* VertexList, int VertexNum, unsigned long* IndexList, int IndexNum, ID3D11DeviceContext* Context);
	bool ObjectCreate(ID3D12Device* Device, Vertex* VertexList, int VertexNum, unsigned long* IndexList, int IndexNum);
